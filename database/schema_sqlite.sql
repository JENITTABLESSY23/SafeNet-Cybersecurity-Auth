...
-- Generated from schema.sql (the MySQL/production reference) — the only
-- difference is the primary-key syntax, since SQLite does not understand
-- MySQL's AUTO_INCREMENT keyword.
-- Keep this in sync with schema.sql if you change either one.
